create table customer(cid varchar2(12) primary key,     -- 고객아이디
    ...
    urank number(2) default 9       -- 고객등급(1:최고관리자, 2:일반관리자, 3:VIP회원, 4:우수회원, 9:일반회원)
);
desc customer;
...
insert into customer(cid, upw, uname, tel, email, birth, urank) values ('cuh','1231','정우희','010-3348-4321','cuh@kakao.com','1984-05-12',2);
insert into customer(cid, upw, uname, tel, email, birth, urank) values ('seul','4321','설공주','010-6353-3014','seul@gmail.com','1998-07-14',3);
insert into customer(cid, upw, uname, tel, email, birth, urank) values ('relea','1111','데렐라','010-7329-1993','relea@hanmail.net','1983-02-14',4);
insert into customer(cid, upw, uname, tel, email, birth) values ('moana','3333','모아나','010-9407-9611','moana@naver.com','1987-10-03');
insert into customer(cid, upw, uname, tel, email, birth) values ('hontas','2222','혼타스','010-3740-2896','hontas@daum.com','1991-08-14');
insert into customer(cid, upw, uname, tel, email, birth) values ('jaess','4444','재스민','010-5576-3289','jaess@naver.com','1988-05-04');
insert into customer(cid, upw, uname, tel, email, birth) values ('poon','7777','라푼젤','010-8200-5633','poon@gmail.com','1985-06-27');
